...
select EmployeeDepartments.EmployeeName, Employees_40.Salary
from EmployeeDepartments
inner join Employees_40 on EmployeeDepartments.EmployeeID=Employees_40.EmployeeID
where Salary >'5000'
...
from Employees_40
left outer join EmployeeDepartments on Employees_40.EmployeeID=EmployeeDepartments.EmployeeID
...
select Products.ProductName, Suppliers.Supplier_type
from Products
right join Suppliers on Products.ProductID=Suppliers.ProductID
...
VALUES
(1, 1, 150.00, '2025-01-05', 'Credit Card'),
(2, 2, 200.50, '2025-01-08', 'Cash'),
(3, 3, 300.00, '2025-01-10', 'Bank Transfer'),
(4, 4, 120.75, '2025-01-12', 'Debit Card'),
(5, 5, 90.00, '2025-01-15', 'Cash'),
(6, 6, 275.50, '2025-01-18', 'Credit Card'),
(7, 7, 350.00, '2025-01-20', 'Bank Transfer'),
(8, 8, 220.25, '2025-01-22', 'Cash'),
(9, 9, 310.50, '2025-01-25', 'Debit Card'),
(10,10, 400.75, '2025-01-28', 'Credit Card'),
(11,11, 175.00, '2025-02-01', 'Cash'),
(12,12, 290.50, '2025-02-03', 'Bank Transfer'),
(13,13, 210.25, '2025-02-05', 'Debit Card'),
(14,14, 340.75, '2025-02-08', 'Credit Card'),
(15,15, 130.00, '2025-02-10', 'Cash'),
(16,16, 195.25, '2025-02-12', 'Debit Card'),
(17,17, 420.00, '2025-02-15', 'Bank Transfer'),
(18,18, 150.50, '2025-02-17', 'Credit Card'),
(19,19, 250.00, '2025-02-20', 'Cash'),
(20,20, 375.25, '2025-02-23', 'Bank Transfer'),
(21,21, 290.50, '2025-02-25', 'Debit Card'),
(22,22, 165.00, '2025-02-27', 'Credit Card'),
(23,23, 245.75, '2025-03-01', 'Cash'),
(24,24, 195.00, '2025-03-03', 'Bank Transfer'),
(25,25, 310.75, '2025-03-05', 'Debit Card'),
(26,26, 400.50, '2025-03-07', 'Credit Card'),
(27,27, 145.00, '2025-03-09', 'Cash'),
(28,28, 260.25, '2025-03-12', 'Bank Transfer'),
(29,29, 120.50, '2025-03-15', 'Debit Card'),
(30,30, 310.00, '2025-03-18', 'Credit Card'),
(31,31, 185.75, '2025-03-20', 'Cash'),
(32,32, 275.25, '2025-03-22', 'Bank Transfer'),
(33,33, 220.50, '2025-03-25', 'Debit Card'),
(34,34, 350.00, '2025-03-28', 'Credit Card'),
(35,35, 140.25, '2025-03-30', 'Cash'),
(36,36, 255.50, '2025-04-01', 'Bank Transfer'),
(37,37, 185.00, '2025-04-03', 'Debit Card'),
(38,38, 310.75, '2025-04-05', 'Credit Card'),
(39,39, 425.50, '2025-04-08', 'Without payment'),
(40,40, 370.00, '2025-04-10', 'Bank Transfer');


select * from Orders
select * from payments

select Orders.CustomerID, Orders.Quantity, payments.paymentmethod
from Orders
full outer join payments on Orders.CustomerID=payments.customerID
...
drop table Managers
insert into Managers(ManagerID, EmployeeID, ManagerName)
values
(1,1,'Alex'),
(2,2,'Bob'),
(3,3,'Sam'),
...
select Employees_40.Name, managers.ManagerName
from Employees_40, Managers
where Employees_40.EmployeeID= managers.employeeid

-----7
select * from Products
select * from Sales

select Products.ProductName, sales.Sales_qty, Products.Price
from Products
...
select Employees_40.Name, EmployeeDepartments.DepartmentName
from Employees_40
left join EmployeeDepartments on Employees_40.EmployeeID= EmployeeDepartments.EmployeeID
...
select Employees_40.Name, Employees_40.Salary, EmployeeDepartments.DepartmentName
from Employees_40
join EmployeeDepartments on Employees_40.DepartmentID= EmployeeDepartments.departmentID
where Employees_40.Salary>(
select avg(Salary)
from Employees_40
where Employees_40.DepartmentID= EmployeeDepartments.departmentID)
...
from Customers
cross join Orders 
where Quantity>'2' and year(orders.orderdate)=2023

create database Homework_new_tables
...
select c.firstname, c.lastname,s.saleamount
from Customers c
inner join Sales s
...
select o.productid,o.quantity,p.paymentmethod
from Orders o
...
select o.customerid,c.firstname,c.lastname,c.country,o.totalamount
from Orders o
inner join Customers c
...
select p.paymentid,o.quantity,pr.productname,
(o.Quantity*pr.Price) total
from Payments p
inner join Orders o
on p.OrderID=o.OrderID
inner join Products pr
on O.ProductID=pr.ProductID
and p.Amount !=(o.Quantity*pr.Price)
...
FROM 
    Employees E1
JOIN 
    Employees E2 ON E1.EmployeeID = E2.ManagerID
WHERE 
    E1.Salary <= E2.Salary;
...
select o.orderid, p.paymentmethod,c.customerid
from Orders o
join Payments p on
o.OrderID=p.OrderID
